...
char const HELP[] = "save <KEY> <VALUE>\n\tSave <VALUE> as <KEY>\n\n"
...
void
load(k::session& session, std::string const& key)
{
...
void
save(k::session& session, std::string const& key, std::string const& value)
{
...
main(int argc, char** argv)
{
  ...
  auto main_loop = std::async(std::launch::async, &k::session::run, &session);
